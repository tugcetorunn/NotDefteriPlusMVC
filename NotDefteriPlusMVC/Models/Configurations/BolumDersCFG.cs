    ...
    public class BolumDersCFG : IEntityTypeConfiguration<BolumDers>
    {
        public void Configure(EntityTypeBuilder<BolumDers> builder)
        {
            ...
            builder.HasData(
                ...
                new BolumDers { BolumId = 7, DersId = 5 },
                new BolumDers { BolumId = 7, DersId = 6 },
                new BolumDers { BolumId = 8, DersId = 7 },
                new BolumDers { BolumId = 9, DersId = 8 },
                new BolumDers { BolumId = 10, DersId = 9 },
                new BolumDers { BolumId = 11, DersId = 10 },
